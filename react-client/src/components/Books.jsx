    ...
    render(){
        ...
        return (
            <ul class="cards">
                ...
                <Book title="Ali's Attraction and Repulsion" author="Morteza Motahhari" desc="A brilliant low profile leadership book. Defines justice, hypocrisy and leadership by addressing leadership's side effect of making friends and enemies." img={require('../images/bank.jpg')} />
